...
from app.model.take_user_input import input_data_for_optimizer

# import multiprocessing


# RUNNER_LOGGER = utils.setup_logging("run", config.SHARED_LOGGING_PARAMETERS)
...
def read_input_data(data=input_data_for_optimizer):
    ...
    # RUNNER_LOGGER.info("RUNNING FUNCTION : read_input_data(file, path) " + "\n")
...
sales_forecast_data=sls_fcst_df.copy()
option_specs=option_spec_df.copy()
# option=unique_options.copy()
option=unique_options[1]
...
def subset_option_input_data(sales_forecast_data, option_specs, option):
    ...
    # RUNNER_LOGGER.info(
    #     "COMPLETED FUNCTION : subset_option_input_data(sales_forecast_data, option_specs, option) " # noqa: E501
    #     + "\n"
    #     + "-" * 100
    #     + "\n"
    # )
...
def build_model_object():
    ...
    # RUNNER_LOGGER.info(
    #     "COMPLETED FUNCTION : build_model_object (name=drop_frequency_optimization) "
    #     + "\n"
    #     + "-" * 100
    #     + "\n"
    # )
...
def create_decision_varbs(model, input_data_option):
    ...
    # RUNNER_LOGGER.info(
    #     "COMPLETED FUNCTION : create_decision_varbs(model, input_data_option) "
    #     + "\n"
    #     + "-" * 100
    #     + "\n"
    # )
...
def add_constraints_handle_first_drop(model, input_data_option):
    # RUNNER_LOGGER.info(
    #     "RUNNING FUNCTION : add_constraints_handle_first_drop(model, input_data_option)" # noqa: E501
    #     + "\n"
    # )
    ...
    # RUNNER_LOGGER.info("^ Total weeks to plan drops = " + str(num_wks_drops_plan))
    # RUNNER_LOGGER.info("^ Total buy quantity = " + str(ub_drop_qty))
    # RUNNER_LOGGER.info("^ SMOQ level = " + str(smoq))
    # RUNNER_LOGGER.info(
    #     "^ Desired weeks of cover to maintain = " + str(woc_to_be_maintained)
    # )
    # RUNNER_LOGGER.info("^ Carrover ? = " + str(carryover))
    # RUNNER_LOGGER.info("^ BOH inventory = " + str(boh_invt))
    ...
    if first_woc > 0:
        ...
        # RUNNER_LOGGER.info(
        #     "^ First drop for this option is through WOC = " + str(first_woc)
        # )
    ...
    if first_drop_shelf_cap > 0:
        ...
        # RUNNER_LOGGER.info(
        #     "^ First drop for this option is through Shelf_capacity = "
        #     + str(first_drop_shelf_cap)
        # )

    # RUNNER_LOGGER.info("@@@ This option will have only 1 drop in week 1 @@@")

    # RUNNER_LOGGER.info(
    #     "COMPLETED FUNCTION : add_constraints_handle_first_drop(model, input_data_option) " # noqa: E501
    #     + "\n"
    #     + "-" * 100
    #     + "\n"
    # )
...
def add_constraints_remaining_1(model, input_data_option, first_drop_size):
    ...
    # RUNNER_LOGGER.info("Adding first set of constraints")
    ...
    # RUNNER_LOGGER.info("^ Number of clearance weeks = " + str(num_clearance_weeks))
    ...
    for i in range(num_wks_drops_plan):
        model.Add(model._dv_woc[i] >= 1500).OnlyEnforceIf(model._dv_invt_zero[i].Not())
        model.Add(model._dv_woc[i] < 1500).OnlyEnforceIf(model._dv_invt_zero[i])

    # RUNNER_LOGGER.info(
    #     "COMPLETED FUNCTION : add_constraints_remaining_1(model, input_data_option)"
    #     + "\n"
    #     + "-" * 100
    #     + "\n"
    # )
...
def add_constraints_remaining_2(model, input_data_option):
    ...
    # RUNNER_LOGGER.info("Adding second set of constraints")
    ...
    if input_data_option["woc_to_be_maintained"] > 4:
        for i in range(num_wks_drops_plan):
            model.Add(model._dv_woc[i] >= 4000).OnlyEnforceIf(model._dv_woc_4[i].Not())
    ...
    # RUNNER_LOGGER.info(
    #     "COMPLETED FUNCTION : add_constraints_remaining_2(model, input_data_option)"
    #     + "\n"
    #     + "-" * 100
    #     + "\n"
    # )
...
def add_constraints_regular_drops(model, input_data_option, first_drop_size):
    ...
    # RUNNER_LOGGER.info("Adding regular drops constraints")
    ...
    # RUNNER_LOGGER.info(
    #     "COMPLETED FUNCTION : add_constraints_regular_drops(model, input_data_option, first_drop_size)" # noqa: E501
    #     + "\n"
    #     + "-" * 100
    #     + "\n"
    # )
...
def build_objective_function(model):
    ...
    # RUNNER_LOGGER.info(
    #     "COMPLETED FUNCTION : build_objective_function(model)" + "\n" + "-" * 100 + "\n" # noqa: E501
    # )
...
def run_optimization_workflow(sales_forecast_data, option_specs, option):
    ...
    # RUNNER_LOGGER.info(
    #     "***** Start optimization model building and solving for option = "
    #     + option
    #     + " *****"
    #     + "\n"
    # )
    ...
    # RUNNER_LOGGER.info(
    #     "COMPLETED FUNCTION : run_optimization_workflow(sales_forecast_data, option_specs, option)" # noqa: E501
    #     + "\n"
    #     + "-" * 100
    #     + "\n"
    # )
...
def create_drop_schedule_report(
    ...
    # RUNNER_LOGGER.info(
    #     "COMPLETED FUNCTION : create_drop_schedule_report(model, sales_forecast_data, input_data_option, opt)" # noqa: E501
    #     + "\n"
    #     + "-" * 100
    #     + "\n"
    # )
    ...
    # RUNNER_LOGGER.info(
    #     "$$$ OPTIMIZATION PROGRAM RAN SUCCESSFULLY FOR OPTION = "
    #     + str(opt)
    #     + " $$$"
    #     + "\n"
    #     + "\n"
